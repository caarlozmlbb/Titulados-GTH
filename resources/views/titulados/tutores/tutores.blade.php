            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h4 class="card-title">Lista de tutores</h4>
                            <p class="card-title-desc">Turores</p>
                        </div>
                        <div>
                            <!-- Botón para abrir el modal -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDocumentModal">
                                <i class="fas fa-plus"></i> Agregar Nuevo tutor
                            </button>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr data-id="1">
                                    ...
                                    <td style="width: 100px">
                                        ...
                                        <!-- Botón para Eliminar -->
                                        <a class="btn btn-outline-danger btn-sm delete" title="Delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este elemento?')">
                                            <i class="fas fa-trash-alt"></i>
                                        </a>

                                        <!-- Botón para Actualizar -->
                                        <a class="btn btn-outline-success btn-sm update" title="Update">
