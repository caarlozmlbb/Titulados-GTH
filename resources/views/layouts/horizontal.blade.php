                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout"
                                role="button">
                                <i class="uil-window-section me-2"></i>@lang('translation.Layouts') <div class="arrow-down">
                                </div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layout-verti">
                                        ...
                                        <a href="layouts-colored-sidebar"
                                            class="dropdown-item">@lang('translation.Colored_Sidebar')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layout-hori">
                                        ...
                                        <a href="layouts-hori-topbar-dark"
                                            class="dropdown-item">@lang('translation.Dark_Topbar')</a>
                                        <a href="layouts-hori-boxed-width"
