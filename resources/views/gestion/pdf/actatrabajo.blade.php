...
<head>
    ...
    <style>
        ...
        .university-name {
            font-size: 18px; /* Tamaño del nombre de la universidad */
            font-weight: bold; /* Negrita para el nombre */
        }
        .university-info {
            font-size: 12px; /* Tamaño de la información adicional */
        }
    ...
    <div class="content">
        <table class="header-table">
            <tr>
                ...
                <td class="large-box">
                    <div class="university-name">Universidad Pública de El Alto</div>
